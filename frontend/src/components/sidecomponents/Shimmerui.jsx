                  ...
                  <div className="p-6 space-y-4 text-center">
                    ...
                    <div className="flex w-full items-center gap-4 mx-auto max-w-xs justify-center">
                      <div className="space-y-2 text-center">
                        <h3 className="text-xl font-semibold shimmer-content w-48 h-6 bg-gray-300"></h3>
                        <p className="text-sm text-gray-500 dark:text-gray-400 shimmer-content w-60 h-4 bg-gray-300"></p>
                      </div>
                    </div>
                    <div className="flex w-full items-center gap-4 mx-auto max-w-xs justify-center">
...
const Shimmerui = () => {
  // Generate an array with 50 elements to map over
  const shimmerArray = new Array(50).fill(null);
